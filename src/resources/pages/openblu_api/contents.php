<?PHP
    ...
    $WebApplication = array(
        'location' => $Configuration['openblu_api']['location'],
    );

    $WebApplication['openblu'] = $WebApplication['location'] . DIRECTORY_SEPARATOR . 'OpenBlu';
    $WebApplication['intellivoid_accounts'] = $WebApplication['location'] . DIRECTORY_SEPARATOR . 'IntellivoidAccounts';
    $WebApplication['modular_api'] = $WebApplication['location'] . DIRECTORY_SEPARATOR . 'ModularAPI';
    ...
    $it = new RecursiveDirectoryIterator($WebApplication['location']);
                                                ...
                                                <div class="panel">
                                                    ...
                                                    <div id="<?PHP HTML::print($key . '_col'); ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="<?PHP HTML::print($key); ?>">
                                                        <div class="panel-body">
                                                            ...
                                                            <form action="/openblu_api?action=update_configuration&file=<?PHP print(urlencode($key)); ?>" method="POST">
                                            ...
                                            <div class="panel">
                                                ...
                                                <div id="<?PHP HTML::print($key . '_col'); ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="<?PHP HTML::print($key); ?>">
                                                    <div class="panel-body">
                                                        ...
                                                        <form action="/openblu_api?action=update_json&file=<?PHP print(urlencode($key)); ?>" method="POST">
                                                            <div class="form-group">
