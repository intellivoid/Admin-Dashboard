                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form>
                                        ...
                                        <button type="button" class="btn btn-block btn-info" onclick="location.href='/coffee_house_requests?filter=<?PHP print(urlencode($AccessKey->PublicID)); ?>';">View Request History</button>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <button type="button" onclick="location.href='/coffee_house_edit_access_key?action=generate_signatures&id=<?PHP print(urlencode($_GET['id'])); ?>';" class="btn btn-success">Generate New Signatures</button>
                                </div>
                            </div>
                        </div>
