                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <div class="row">
                                        <h4>Cancel Plan</h4>
                                        <button type="button" onclick="location.href='/coffee_house_edit_plan?action=cancel_plan&id=<?PHP print(urlencode($_GET['id'])); ?>';" class="btn btn-danger">Cancel Plan</button>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <h4>Start Plan</h4>
                                        <form action="/coffee_house_edit_plan?action=start_plan&id=<?PHP print(urlencode($_GET['id'])); ?>" method="POST">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="/coffee_house_edit_plan?action=update_plan&id=<?PHP print(urlencode($_GET['id'])); ?>" method="POST">
                                        ...
                                        <button type="button" class="btn btn-block btn-success" onclick="location.href='/coffee_house_edit_access_key?id=<?PHP print(urlencode($Plan->AccessKeyId)); ?>'">View</button>
                                        ...
                                        <div class="form-group">
                                            <label for="plan_type">Plan Type</label>
                                            <select name="plan_type" autocomplete="off" id="plan_type" class="form-control">
                                                <option value="0"<?PHP if($Plan->PlanType == \CoffeeHouse\Abstracts\APIPlan::Free){ print(' selected'); } ?>>Free</option>
                                                <option value="1"<?PHP if($Plan->PlanType == \CoffeeHouse\Abstracts\APIPlan::Basic){ print(' selected'); } ?>>Basic</option>
                                                <option value="2"<?PHP if($Plan->PlanType == \CoffeeHouse\Abstracts\APIPlan::Enterprise){ print(' selected'); } ?>>Enterprise</option>
                                            </select>
                                        </div>
